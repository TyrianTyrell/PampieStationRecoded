...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	//new/datum/stack_recipe("crib", /obj/structure/bed/crib, 3, one_per_turf = TRUE, on_floor = TRUE), \
))
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("changing table", /obj/structure/bed/changingtable, 4, time = 10, one_per_turf = TRUE, on_floor = TRUE), \
	...
	//new/datum/stack_recipe("wooden highchair", /obj/structure/chair/highchairwood, 2, one_per_turf = TRUE, on_floor = TRUE, time = 5),\
	))
...
GLOBAL_LIST_INIT(cloth_recipes, list ( \
	...
	new/datum/stack_recipe("bouncer", /obj/structure/chair/bouncer, 2, one_per_turf = TRUE, on_floor = FALSE), \
	null, \
...
GLOBAL_LIST_INIT(plastic_recipes, list(
	...
	new /datum/stack_recipe("shower curtain", /obj/structure/curtain, 10, time = 10, one_per_turf = TRUE, on_floor = TRUE), \
	...
	new /datum/stack_recipe("diaper pail", /obj/structure/closet/crate/diaperpail, 10, one_per_turf = TRUE, on_floor = TRUE, time = 15), \
	new /datum/stack_recipe("potty", /obj/structure/potty, 10, one_per_turf = TRUE, on_floor = TRUE, time = 20)))

...
//Ash walkers on birth understand how to make bone bows, bone arrows and ashen arrows
	...
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/goliath_drapes)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/diamond_scalpel)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_retractor)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/diamond_bonesaw)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/femurstat)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_bonesetter)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/coretery)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_spade)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_hatchet)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_cultivator)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/bone_glaive)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/ashwalker_tools_tablet)
	new_spawn.mind.teach_crafting_recipe(/datum/crafting_recipe/ashwalker_glaive_tablet)

...
/datum/game_mode/traitor
	...
	restricted_jobs = list("Prisoner", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Prisoner", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster") //Cyborgs are part of the AI, if it is traitor so are they; they used to get double chances
	protected_jobs = list("Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster")	//citadel change - adds HoP, CE, CMO, and RD to ling role blacklist
	required_players = 0
	required_enemies = 1

...
/datum/game_mode/changeling
	...
	chaos = 5
	restricted_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Prisoner", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster")
	protected_jobs = list("Prisoner", "Chief Engineer", "Chief Medical Officer", "Research Director", "Quartermaster")	//citadel change - adds HoP, CE, CMO, and RD to ling role blacklist
	required_players = 15
	required_enemies = 1

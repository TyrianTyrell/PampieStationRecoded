...
/datum/techweb_node/alien_surgery
	...
	design_ids = list("surgery_brainwashing","surgery_robot_brainwashing","surgery_unpottytrain","surgery_zombie", "surgery_ext_dissection", "surgery_heal_combo_upgrade_femto")

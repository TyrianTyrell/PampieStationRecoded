...
/datum/design/regressoray
	name = "Regression Ray"
	desc = "Temporarily severs neural connections, resetting the brain to a base state- essentially rendering someone's mental status that of an infant until it wears off."
	id = "regresso_ray"
	build_type = PROTOLATHE

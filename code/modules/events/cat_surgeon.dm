...
/datum/round_event/cat_surgeon/announce(fake)
	priority_announce("One of our... ahem... 'special' cases has escaped. As it happens, their last known location before their tracker implant went dead is your station, so keep an eye out for them. On an unrelated note, has anyone seen our cats?",

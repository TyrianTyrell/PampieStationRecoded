...
/datum/round_event/disease_outbreak/start()
	...
	if(!virus_type && !advanced_virus)
		virus_type = pick(/datum/disease/dnaspread, /datum/disease/advance/flu, /datum/disease/advance/lupus, /datum/disease/advance/cold, /datum/disease/brainrot, /datum/disease/magnitis)

...
/mob/living/carbon/proc/DisplayFlavortextMessage(messageType) //this proc handles all the flavortext messages for accidents and warnings
	...
	if(!FlavortextQuery.Execute(db))
		...
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[usr]",usr.name)
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src]",src.name) //Since SQL doesn't know what to do with src.p_they(), I've made this solution.
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_they()]",src.p_they())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_their()]",src.p_their())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_are()]",src.p_are())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_them()]",src.p_them())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_theyre()]",src.p_theyre())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_theyve()]",src.p_theyve())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_do()]",src.p_do())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_es()]",src.p_es())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_have()]",src.p_have())
		FlavortextQueryResponse["othersmessage"] = replacetext(FlavortextQueryResponse["othersmessage"],@"[src.p_were()]",src.p_were())

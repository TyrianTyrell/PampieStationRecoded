...
//If the Obsessed examines first, then the obsession examines them, there's a 50% chance to possibly blow their cover. Wearing a mask avoids this risk.
...
/datum/brain_trauma/special/obsessed/proc/find_obsession()
	...
	var/static/list/trait_obsessions = list(
		/* We don't have these traits... yet? JOB_MIME = TRAIT_MIME_FAN,

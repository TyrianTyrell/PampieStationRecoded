...
/datum/controller/subsystem/job/proc/EquipRank(mob/M, rank, joined_late = FALSE)
	...
	if(job)
		if(!job.dresscodecompliant && M.client.prefs.dresscodes == FALSE)// CIT CHANGE - dress code compliance
...
/*		if(M.client.holder)
	...
	if(job && H)
		if(job.dresscodecompliant && M.client.prefs.dresscodes == TRUE)// CIT CHANGE - dress code compliance
			equip_loadout(N, H) // CIT CHANGE - allows players to spawn with loadout items
